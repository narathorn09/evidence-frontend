...
const CloseCase = () => {
  ...
  return (
    <div>
      <Helmet>
        <title>ปิดคดี - Forensic Science</title>
      </Helmet>
      <BreadcrumbLayout
        pages={[
          { title: "จัดการคดี" },
          ...
          {
            title: `ปิดคดี หมายเลข บก. ที่ ${caseData?.case_numboko}`,
          },
        ]}
      />
      <Box sx={{ width: "100%", height: "100%" }}>
        <Grid sx={{ textAlign: "left", mb: 2 }}>
          <h2 style={{ color: "var(--color--main)" }}>ปิดคดี</h2>
        </Grid>
        <Card
          sx={{
            p: 1,
        ...
        >
          ...
          <Button
            type="primary"
            onClick={() => CloseCase(caseData?.case_id, caseData?.case_numboko)}
          >
            ยืนยัน
          </Button>
        </div>
