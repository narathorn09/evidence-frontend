...
const ListCaseAllWork = () => {
    ...
    },
    {
      ...
      renderCell: (params) => (
        <ButtonAntd
          onClick={() => {
            navigate(
              `/commander/manage-case/list-case-work/detail/${params?.row?.id}`
            );
          }}
  ...
  const csvOptions = {
    fileName: "รายการคดีที่ดำเนินการอยู่",
    utf8WithBom: true,
  ...
  return (
    <div>
      ...
      <BreadcrumbLayout
        pages={[{ title: "คดี" }, { title: "รายการคดีที่ดำเนินการอยู่" }]}
      />
      <Grid
        sx={{
          height: "100%",
      ...
      >
        <Grid sx={{ textAlign: "left" }}>
          <h2>รายการคดีที่ดำเนินการอยู่</h2>
        </Grid>
...
export default ListCaseAllWork;
