              ...
              <Box key={index}>
                ...
                >
                  ...
                  {item?.evidence_factor?.map((itemFactor, i) => {
                            let textStatus;
                            let colorStatus;
                            if (itemFactor.assign_evi_result === "พบ DNA") {
                              textStatus = "พบ DNA";
                              colorStatus = "success";
                            } else if (itemFactor.assign_evi_result === "ไม่พบ DNA") {
                              textStatus = "ไม่พบ DNA";
                              colorStatus = "error";
                            } else if (itemFactor.assign_evi_result === null) {
                              textStatus = "-";
                              colorStatus = "";
                            }
                    return (
...
export default GetCaseConfirmById;
